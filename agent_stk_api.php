...
if(isset($_POST['submit'])){
  ...
  */
  ...
  $AccountReference = $_POST['storenumber'];
  $TransactionDesc = 'Withdraw from Agent';
  $Amount = $_POST['amount'];
  ...
  $curl_post_data = array(
    ...
    'Password' => $Password,
    'Timestamp' => $Timestamp,
    'TransactionType' => 'CustomerToAgentTransfer', // Customer to business for withdrawals
    // 'TransactionType' => 'payment', // For send money
